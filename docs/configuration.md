...
FM_CREW_STATE_LIVE_ROW_MAX_AGE=21600   # seconds a live run row whose head this copy cannot resolve stays trusted; past it the anchored inference reports unknown instead of working (bin/fm-crew-state.sh owns the rule)
