...
Ordinary shell commands, fleet-script names used as data, all commands in an idle fleet, child worktrees, session start, wake drain, watcher arm, ordinary literal teardown, and exact sentinel enable remain allowed.
