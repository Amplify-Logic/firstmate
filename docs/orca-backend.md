...
5. Write metadata, then send the worker env exports (`GOTMPDIR` and the `FM_HERDR_PROJECT_*` pin) and the selected harness launch through the recorded Orca terminal.
