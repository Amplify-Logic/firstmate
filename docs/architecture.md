...
The phone bridge page is a bearings glance plus one authenticated photo drop, served on loopback and published with Tailscale Serve; see [`bridge-view.md`](bridge-view.md).
