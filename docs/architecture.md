...
Declared waits that share one blocking reason recheck as a single digest item; a wait that names an explicit captain decision uses the longer `FM_PAUSE_CAPTAIN_RESURFACE_SECS` cadence.
