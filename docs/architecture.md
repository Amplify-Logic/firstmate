...
Repeated outage alerts back off exponentially, and deliberate home-scoped `disarm` remains visible in every session-start digest until an explicit verified `enable`.
