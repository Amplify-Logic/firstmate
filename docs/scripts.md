...
| `fm-overlay.sh`          | Open a Markdown view as an in-terminal Herdr overlay pane, degrading to the loopback link; installs nothing and is called nowhere by default (docs/chart-room.md) |
