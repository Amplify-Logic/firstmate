...
| `fm-action-runner-v2.py` | Gateway v2 execution relay: claims one lease, runs the bound executor, reports back; holds no approval authority and its report never decides the outcome (docs/action-gateway-v2.md) |
