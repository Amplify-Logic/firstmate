...
`tests/fm-triage-second-look.test.sh` (27 assertions) drives the real classifier, the real request build and the real thresholds, stubbing only the HTTP response.
