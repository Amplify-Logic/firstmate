...
Decision-owned signal and stale routing, including whole-batch precedence and the independent heartbeat exception, is owned by `docs/pi-supervision-branch.md#components-and-their-owners`.
