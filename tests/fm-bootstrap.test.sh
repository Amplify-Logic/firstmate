...
kimi primary harness is rejected for worker dispatch^{"default":{"harness":"kimi"}}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - unverified harness: kimi
