...
kimi worker harness is accepted in dispatch^{"default":{"harness":"kimi"}}^empty^
kimi effort is flagged like opencode^{"rules":[{"when":"kimi work","use":{"harness":"kimi","model":"kimi-code/k3","effort":"high"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid effort: kimi:high
standing cursor dispatch profile is accepted^{"rules":[{"when":"High-complexity technical design, product design, architecture decisions, creative or story-related work, UX design, or anything where depth and creativity matter more than speed.","use":{"harness":"claude","model":"fable","effort":"high"},"why":"Reserve the premium pool for depth and creativity."},{"when":"Any other crewmate or scout task: features, bugfixes, refactors, tests, trivial mechanical edits, investigation, audits, research, planning.","use":{"harness":"cursor","model":"gpt-5.6-sol-xhigh"},"why":"Use the standing Cursor worker default."}],"default":{"harness":"cursor","model":"gpt-5.6-sol-xhigh"}}^empty^
cursor effort range is accepted^{"rules":[{"when":"cursor effort mapping","use":[{"harness":"cursor","model":"gpt-5.6-sol","effort":"low"},{"harness":"cursor","model":"gpt-5.6-sol","effort":"medium"},{"harness":"cursor","model":"gpt-5.6-sol","effort":"high"},{"harness":"cursor","model":"gpt-5.6-sol","effort":"xhigh"},{"harness":"cursor","model":"gpt-5.6-sol","effort":"max"}],"select":"quota-balanced"}]}^empty^
prime-agent effort range is accepted^{"rules":[{"when":"prime-agent effort mapping","use":[{"harness":"prime-agent","model":"opencode/deepseek-v4-flash-free","effort":"low"},{"harness":"prime-agent","model":"opencode/deepseek-v4-flash-free","effort":"medium"},{"harness":"prime-agent","model":"opencode/deepseek-v4-flash-free","effort":"high"},{"harness":"prime-agent","model":"opencode/deepseek-v4-flash-free","effort":"xhigh"},{"harness":"prime-agent","model":"opencode/deepseek-v4-flash-free","effort":"max"}],"select":"quota-balanced"}]}^empty^
...
array use with capability-recent is accepted^{"rules":[{"when":"big feature","use":[{"harness":"claude","model":"claude-sonnet-5","effort":"high"},{"harness":"codex","model":"gpt-5.5","effort":"high"}],"select":"capability-recent"}]}^empty^
