...
# Fork keeps fm-capability-lib.sh (capability-recent dispatch); upstream optional
# siblings cover main-only deps a branch baseline may not have yet.
OLD_BIN_UNCHANGED_SIBLINGS="fm-gate-refuse-lib.sh fm-guard.sh fm-lock-lib.sh fm-tasks-axi-lib.sh fm-pr-lib.sh fm-tangle-lib.sh fm-tmux-lib.sh fm-composer-lib.sh fm-busy-lib.sh fm-marker-lib.sh fm-wake-lib.sh fm-classify-lib.sh fm-supervision-lib.sh fm-ff-lib.sh fm-secondmate-registry-lib.sh fm-config-inherit-lib.sh fm-project-mode.sh fm-harness.sh fm-crew-state.sh fm-decision-hold.sh fm-backend.sh fm-capability-lib.sh fm-public-followup-lib.sh fm-x-lib.sh"
...
OLD_BIN_OPTIONAL_SIBLINGS="fm-operational-input.sh fm-pending-reply-lib.sh fm-path-lib.sh fm-timeout-lib.sh fm-worktree-lease-lib.sh"
