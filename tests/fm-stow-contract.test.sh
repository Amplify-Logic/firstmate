...
test_stow_skill_task_note_contract() {
  ...
  # The exact syntax is pinned to bin/fm-tasks-axi.sh, not to a bare tasks-axi
  # call: AGENTS.md section 10 requires every backlog call to go through that
  # wrapper so it reaches this home's backlog from any working directory.
