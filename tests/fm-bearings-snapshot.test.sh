...
# Cross-home probes are intentionally bounded, but loaded CI hosts need more than
# the production fast-path minimum for non-timeout fixtures.
export FM_SNAPSHOT_REGISTRY_TIMEOUT=5
export FM_SNAPSHOT_SECONDMATE_TIMEOUT=5
export FM_SNAPSHOT_PARENT_ACTIVITY_TIMEOUT=5
export FM_SNAPSHOT_TERMINAL_TIMEOUT=5
