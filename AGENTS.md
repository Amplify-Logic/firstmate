...
config/primary-handoff  optional quota-aware primary orchestrator rotation; LOCAL, gitignored; absent or enabled:false leaves primary launch unchanged; see docs/primary-handoff.md
...
state/               volatile runtime signals; gitignored
  ...
  .primary-active .primary-handoff*   optional quota-aware primary-handoff supervisor state; present only when config/primary-handoff enables it (docs/primary-handoff.md)
