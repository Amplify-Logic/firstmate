...
state/               runtime records and signals; gitignored
  ...
  desk-voice/        durable desk-floater push-to-talk fallback mailbox, used when a transcript cannot be typed into the primary chat, and the path for messages with screenshots: inbox/ holds pending captain-input transcripts, processed/ holds drained ones, shots/ holds the newest floater screenshots; `bin/fm-desk-voice.sh drain` empties the inbox (docs/desk-floater.md)
