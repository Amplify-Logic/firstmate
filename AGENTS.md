...
state/               runtime records and signals; gitignored
  ...
  desk-voice/        durable desk-floater push-to-talk fallback mailbox, used when a transcript cannot be typed into the primary chat: inbox/ holds pending captain-input transcripts, processed/ holds drained ones; `bin/fm-desk-voice.sh drain` empties it (docs/desk-floater.md)
