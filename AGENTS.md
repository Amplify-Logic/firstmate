...
config/desk-floater-signing-identity  optional codesigning identity for the desk floater, or "-" for ad-hoc; LOCAL, gitignored, not inherited; absent uses the first "Apple Development" identity; see docs/configuration.md "Desk floater signing identity"
