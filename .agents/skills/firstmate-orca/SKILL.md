...
- The emitted supervision protocol for this primary harness whenever there are tasks in flight and this session owns supervision; never arm `bin/fm-watch.sh` by hand where that protocol owns the arm.
