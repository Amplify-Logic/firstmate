...
10. Record a partner-facing ticket's timeline through the channel intake's `observe --timeline-file`, which decides whether the partner is awaiting the captain; `bin/fm-channel-intake.sh --help` owns those rules.
