...
//
// Verified upstream against Pi 0.81.1 declarations and the Pi 0.82.0 CLI, and in this
// fork against Pi 0.80.10, all of which expose ExtensionUIContext.setWidget() with a component factory, per-widget dispose(), and
