...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-account.test.sh 1302
tests/fm-action-gateway-v2.test.sh 14810
...
tests/fm-herdr-session-cleanup.test.sh 8691
tests/fm-herdr-submit-confirm-live-e2e.test.sh 1131
tests/fm-herdr-version-floor-live-e2e.test.sh 1190
tests/fm-herdr-worker-presentation-e2e.test.sh 1154
...
tests/fm-muse-harness.test.sh 59446
tests/fm-muse-signals-live-e2e.test.sh 1244
...
tests/fm-trace-context-spawn.test.sh 73971
