...
# Fork-only test families and changed-path owners are declared in
# tests/fork-test-registry.conf rather than in this runner's own maps, behind a
# missing-safe hook so an upstream copy without the fork library still runs.
# bin/fm-fork-test-registry-lib.sh owns the row grammar and the confinement
# assertions that keep a fork row from silently shadowing an upstream answer.
...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-account.test.sh 1369
tests/fm-action-gateway-v2.test.sh 15290
tests/fm-action-gateway.test.sh 7220
tests/fm-adhd.test.sh 1301
...
tests/fm-baby-menu-quota.test.sh 2088
...
tests/fm-bridge-view.test.sh 13286
tests/fm-browse-session.test.sh 1393
...
tests/fm-continuity-pretool-check.test.sh 7473
tests/fm-control-relaunch.test.sh 48210
tests/fm-control.test.sh 54301
tests/fm-cursor-adapter.test.sh 39523
tests/fm-cursor-harness.test.sh 30103
tests/fm-cursor-primary-live-e2e.test.sh 21
tests/fm-cursor-primary.test.sh 54947
tests/fm-cursor-statusline.test.sh 1550
tests/fm-daemon.test.sh 26870
tests/fm-decision-hold-lifecycle.test.sh 43603
tests/fm-decision-surface.test.sh 7664
tests/fm-deck.test.sh 12373
tests/fm-deepgram-desk.test.sh 2514
tests/fm-dispatch-select.test.sh 1495
tests/fm-documentation-audiences.test.sh 732
tests/fm-extension-binding.test.sh 7398
tests/fm-file-eventwait.test.sh 17153
tests/fm-fleet-snapshot-view.test.sh 8547
tests/fm-fleet-sync.test.sh 37749
tests/fm-fork-surface.test.sh 15410
...
tests/fm-harness-exam.test.sh 19375
...
tests/fm-home-manifest.test.sh 1507
tests/fm-home-port.test.sh 4117
...
tests/fm-landed-completion-truth.test.sh 5617
tests/fm-lint-workflows.test.sh 855
tests/fm-live-gate.test.sh 6000
tests/fm-morning-intake.test.sh 13425
tests/fm-muse-harness.test.sh 55572
tests/fm-muse-signals-live-e2e.test.sh 23
tests/fm-nm-test-contract.test.sh 1269
tests/fm-no-mistakes-ownership.test.sh 1193
...
tests/fm-order.test.sh 10486
tests/fm-overlay.test.sh 1431
...
tests/fm-present.test.sh 2842
tests/fm-primary-handoff.test.sh 11974
tests/fm-primary.test.sh 8163
tests/fm-prime-agent-adapter.test.sh 6863
...
tests/fm-project-presentation.test.sh 1302
...
tests/fm-second-opinion.test.sh 1301
...
tests/fm-send-steer-count.test.sh 4204
...
tests/fm-shift.test.sh 24031
tests/fm-spawn-account.test.sh 11501
tests/fm-spawn-agent-up.test.sh 36545
tests/fm-spawn-dispatch-profile.test.sh 63996
tests/fm-spawn-herdr-env.test.sh 7689
tests/fm-spawn-herdr-presentation.test.sh 15307
tests/fm-spawn-launch-preflight.test.sh 35579
tests/fm-spawn-pool-base-freshen.test.sh 34920
tests/fm-spawn-worktree-settle.test.sh 5687
tests/fm-speak.test.sh 19508
tests/fm-startup-memory-budget.test.sh 6964
tests/fm-startup-network.test.sh 62274
tests/fm-status-bar.test.sh 6808
tests/fm-stow-cascade.test.sh 3101
tests/fm-stow-contract.test.sh 1175
tests/fm-subagent-pretool-check.test.sh 1030
tests/fm-supervision-events.test.sh 719
tests/fm-supervision-sentinel.test.sh 30637
tests/fm-supervision-test-isolation.test.sh 23831
...
tests/fm-timeout-lib.test.sh 2345
tests/fm-tmux-agent-liveness.test.sh 1516
tests/fm-tool-update-check.test.sh 14176
tests/fm-toolchain-drift.test.sh 1732
tests/fm-trace-context-lib.test.sh 209
tests/fm-trace-context-spawn.test.sh 44702
tests/fm-tray.test.sh 1760
tests/fm-turnend-guard.test.sh 42565
tests/fm-update.test.sh 5212
tests/fm-upstream-ledger.test.sh 2635
tests/fm-upstream-watch.test.sh 1733
tests/fm-upstream.test.sh 2753
tests/fm-vendor-auth-probe.test.sh 43316
tests/fm-visible-status.test.sh 4341
tests/fm-voice-relay-appserver.test.sh 12129
...
tests/fm-watch-caffeinate.test.sh 17307
...
tests/fm-worker-boundary-regression.test.sh 32562
tests/no-mistakes-required-workflow.test.sh 1130
EOF
}
