...
# never a clean empty completion. On restart-only healthy it exits zero after the
# duplicate child stands down. On FAILED it exits non-zero so the failure is
